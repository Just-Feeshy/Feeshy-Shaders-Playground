...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FeeshyShaders", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		#if !munit
		var app = new Main();
		app.meta.set("build", "124");
		app.meta.set("company", "Company Name");
		app.meta.set("file", "FeeshyShaders");
		app.meta.set("name", "FeeshyShaders");
		app.meta.set("packageName", "com.sample.feeshyshaders");
